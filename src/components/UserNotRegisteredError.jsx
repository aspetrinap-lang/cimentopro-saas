      ...
      <div className="max-w-md w-full p-8 bg-white rounded-lg shadow-lg border border-slate-100">
        <div className="text-center">
          ...
          <p className="text-slate-600 mb-8">
            Você não está registrado para usar este aplicativo. Entre em contato com o administrador para solicitar acesso.
          </p>
          <div className="p-4 bg-slate-50 rounded-md text-sm text-slate-600">
            <p>Se você acredita que isso é um erro:</p>
            <ul className="list-disc list-inside mt-2 space-y-1">
              <li>Verifique se está logado com a conta correta</li>
              <li>Solicite acesso ao administrador do app</li>
